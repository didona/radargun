...
ID="140214_R"
ISIZE="1000 2000 3000 4000 5000 10000 25000 50000"
RUN="1"
TEST="${ID}_test.out"
home="/home/didona"
writeP="100"
...
benchST="stub/benchmark_remote.xml"
...
do
okillj
TEST_ID=REP${ID}_${isoL}_${ret}_${k}_${op}_${wp}_${rp}_${c}_${rd}_${spin}_${size}_RUN${run}
...
change_retry ${ret}
date >> ${TEST}
echo "Running test with retry ${ret}, isolation level ${isoL}, $k keys, $op operations, $wp writePercentage, $rp replication protocol, $c nodes, $rd replication degree, ${spin} spin, size ${size} The relevant folder will be ${TEST_ID}">>${TEST}
if [ $WPM ]
then
./tosb_wpm.sh $c
else

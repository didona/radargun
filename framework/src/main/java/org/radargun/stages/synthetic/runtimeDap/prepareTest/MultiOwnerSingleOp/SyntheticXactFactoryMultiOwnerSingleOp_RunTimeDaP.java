 ...
 * @since 4.0
 */
public class SyntheticXactFactoryMultiOwnerSingleOp_RunTimeDaP extends SyntheticXactFactory_RunTimeDaP {

   public SyntheticXactFactoryMultiOwnerSingleOp_RunTimeDaP(SyntheticXactParams params) {
      super(params);
   ...
   @Override
   protected SyntheticXactMultiOwnerSingleOp_RunTimeDaP generateXact(SyntheticXactParams p) {
      SyntheticXactMultiOwnerSingleOp_RunTimeDaP s = new SyntheticXactMultiOwnerSingleOp_RunTimeDaP(p);
      s.setRoRead(roRead);
      s.setUpRead(upRead);

...
public class CoreWorkload {
   ...
   protected static IntegerGenerator getFieldLengthGenerator(Properties p) throws RuntimeException {
      IntegerGenerator fieldlengthgenerator;
    ...
    */
   public void init(Properties p) throws RuntimeException {
      ...
      recordcount = Integer.parseInt(p.getProperty(RECORD_COUNT_PROPERTY));
      ...
      if (requestdistrib.compareTo("uniform") == 0) {
         ...
         int opcount = Integer.parseInt(p.getProperty(OPERATION_COUNT_PROPERTY));
...
//	}
   ...
   public int doTransactionScan() {
      return scanlength.nextInt();
   }
